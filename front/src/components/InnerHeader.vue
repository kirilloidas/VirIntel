                ...
                <div class="burger--wrapper d-lg-none d-xl-none">
                    <div class="nav-item dropdown d-lg-none d-xl-none">
                        ...
                        <div class="dropdown-menu">
                            <p><a href="#" class="dropdown-item">My profile</a></p>
                            <p><a href="#" class="dropdown-item">My Patients</a></p>
                            <p><a href="#" class="dropdown-item">Tests</a></p>
                            <p><a href="#" class="dropdown-item">Messages</a></p>
                            <div class="dropdown-divider"></div>
                            <p><router-link to="#" class="dropdown-item">Log out</router-link></p>
                        </div>
                    </div>
                </div>
            </nav>
